...
function initPagination() {
    ...
    */
    ...
    const artCards = Array.from(document.querySelectorAll('.art-card, .live-record, .date-log,.dynamic-item,.yet-another-class,.yet-another-class')).filter(card => getComputedStyle(card).display!== 'none');
    // 总项目数
